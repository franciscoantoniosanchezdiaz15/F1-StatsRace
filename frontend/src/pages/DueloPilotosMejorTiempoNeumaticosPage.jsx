...
import { simularDueloPilotosMejorTiempo } from "../services/dueloPilotosService";

export default function DueloPilotosMejorTiempoNeumaticosPage() {
  ...
  async function handleSubmit(payloadFinal) {
    const resultado = await simularDueloPilotosMejorTiempo(payloadFinal);
    ...
    <div>
      ...
      <div className="w-full bg-neutral-900 border-b border-neutral-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <button
            onClick={() => navigate("/duelos/pilotos/mejor-tiempo", { state: location.state })}
          ...
          <aside className="lg:col-span-1 space-y-6">
            ...
            <div className="p-6 rounded-[32px] bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700">
              ...
              <p className="text-xs italic text-neutral-300">
                "En una vuelta lanzada, cada detalle cuenta. El compuesto correcto puede decidir el duelo."
              </p>
            </div>
          </aside>
