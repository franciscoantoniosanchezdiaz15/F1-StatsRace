...
function StartScreen() {
  ...
  return (
    <div className="relative flex items-center justify-center px-6 overflow-hidden">
          ...
          <div className="relative w-full max-w-2xl bg-neutral-900/40 backdrop-blur-xl p-12 rounded-[40px] border border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)] flex flex-col items-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black italic mb-4 text-white uppercase tracking-tighter leading-none text-center">
            ...
            <button
              ...
              className="group relative px-10 py-3 bg-[#A6051A] rounded-tl-2xl rounded-br-2xl transition-all duration-300 hover:scale-110 active:scale-95 shadow-[0_0_20px_rgba(166,5,26,0.4)] cursor-pointer" 
            >
              <div className="absolute bg-white opacity-0 group-hover:opacity-10 transition-opacity rounded-tl-2xl rounded-br-2xl"></div>
