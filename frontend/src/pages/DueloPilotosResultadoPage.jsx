    ...
    <div className={`relative overflow-hidden rounded-3xl border ${esUsuario ? "border-[#FFEB00]/30 bg-neutral-900" : "border-neutral-800 bg-neutral-900/50"} p-6 shadow-2xl`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-black/40 p-3 rounded-2xl border border-neutral-800">
          ...
          <p className="text-lg font-bold text-white">{piloto.team_name}</p>
        </div>
        <div className="bg-black/40 p-3 rounded-2xl border border-neutral-800">
          <p className="text-[10px] text-neutral-500 font-black uppercase tracking-widest mb-1">
            Dorsal
          </p>
          <p className="text-lg font-bold text-[#FFEB00]">{piloto.driver_number}</p>
        </div>
      </div>

      <h3 className="text-xs font-black text-neutral-400 uppercase tracking-[0.3em] mb-4 border-b border-neutral-800 pb-2">
        Telemetry
      </h3>

      <div className="space-y-3">
        <div className="group bg-neutral-800/50 rounded-2xl p-4 border border-neutral-700/50 hover:border-neutral-500 transition-all">
...
export default function DueloPilotosResultadoPage() {
      ...
      <div>
        ...
        <div className="min-h-screen bg-black text-white flex items-center justify-center">
          <div className="text-center">
            <p className="text-neutral-500 font-black uppercase tracking-widest mb-6">
  ...
  const ganoUsuario = resultado.resultado.ganador === resultado.piloto_1.full_name;
      ...
      <div>
        <section className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-neutral-500 font-black uppercase tracking-[0.4em] mb-12">
              Race Classification Finalized
            </p>
            ...
            <div className="flex items-center gap-8 md:gap-20 bg-neutral-900/80 backdrop-blur-xl p-8 rounded-[40px] border border-white/10 shadow-2xl">
              <div className="text-center">
                <p className="text-[10px] text-neutral-500 font-black uppercase mb-1 tracking-widest">
                  Tu Resultado
                </p>
                <p className="text-4xl font-black italic tracking-tighter">
                  {resultado.resultado.tiempo_1}
                </p>
              </div>

              <div className="text-5xl font-black italic text-[#FFEB00] opacity-20 italic underline">
                VS
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-4xl font-black italic tracking-tighter text-neutral-400">
                  {resultado.resultado.tiempo_2}
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="flex items-center gap-3 bg-neutral-900 border border-white/5 px-6 py-3 rounded-full">
      ...
      <div className="flex flex-col">
        <span className="text-[8px] text-neutral-500 font-black uppercase leading-none mb-1 tracking-tighter">
          {label}
        </span>
