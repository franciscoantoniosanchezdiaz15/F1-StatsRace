...
export default function DueloEscuderiasMejorTiempoNeumaticosPage() {
  ...
  async function handleSubmit(payloadFinal) {
    const resultado = await simularDueloEscuderiasMejorTiempo(payloadFinal);
      ...
      <div>
        ...
        <section className="max-w-xl mx-auto px-6 py-20 text-center">
          <div className="bg-neutral-900 border-2 border-red-600/20 p-10 rounded-[40px] shadow-2xl">
            <h2 className="text-3xl font-black italic uppercase mb-4 tracking-tighter">Sesión Expirada</h2>
    ...
    <div>
      ...
      <div className="w-full bg-neutral-900 border-b border-neutral-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <button
            onClick={() => navigate("/duelos/escuderias/mejor-tiempo", { state: location.state })}
